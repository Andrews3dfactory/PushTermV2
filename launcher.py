...
CLASSIC_PATH = os.path.join(BASE_DIR, "Classic_Mode", "launcher.py")       # Your Classic Mode entry
COMMAND_PATH = os.path.join(BASE_DIR, "Command_Mode", "Pushterm_Terminal_Ui.py")   # Correct Command Mode launcher
...
class Launcher(QtWidgets.QWidget):
    def __init__(self):
        ...
        # Buttons
        self.add_neon_button(overlay_layout,"Classic Mode",launch_classic)
        self.add_neon_button(overlay_layout,"Command Mode",launch_command)
